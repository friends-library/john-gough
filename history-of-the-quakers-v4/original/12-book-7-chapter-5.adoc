...
<table class="tableblock frame-all grid-all stretch table-header-tail-x-small table-last-col-secondary">
  <colgroup>
    <col style="width: 41.6666%;"></col>
    <col style="width: 4.1666%;"></col>
    <col style="width: 4.1666%;"></col>
    <col style="width: 4.1666%;"></col>
    <col style="width: 4.1666%;"></col>
    <col style="width: 4.1666%;"></col>
    <col style="width: 4.1666%;"></col>
    <col style="width: 33.3338%;"></col>
  </colgroup>
  <thead>
    <tr>
...
<table class="tableblock frame-all grid-all stretch table-tail-align-right">
  <colgroup>
    <col style="width: 83.3333%;"></col>
    <col style="width: 8.3333%;"></col>
    <col style="width: 8.3334%;"></col>
  </colgroup>
  <thead>
    <tr>
      <th class="tableblock halign-left valign-top"></th>
...
<table class="tableblock frame-all grid-all stretch">
  <colgroup>
    <col style="width: 61.5384%;"></col>
    <col style="width: 15.3846%;"></col>
    <col style="width: 7.6923%;"></col>
    <col style="width: 7.6923%;"></col>
    <col style="width: 7.6924%;"></col>
  </colgroup>
  <tbody>
    <tr>
