...
[.chapter-synopsis]
* Meetinghouse built in Philadelphia
...
of building a meetinghouse in the city.
...
the meetings were held there, till the bank meetinghouse was built:
The next year friends of Burlington also built a large commodious meetinghouse.
...
through the hottest times of persecution,
...
and desired it might not be brought amongst them,
by which instead of allaying the ferment of corrupt nature,
...
For this purpose religious-minded friends would
...
under the title of [.book-title]#A Testimony to the Lord`'s Power
...
_to be faithful to the little they knew of the fear and will of their maker,_
